...
contract SwapPoolProxyScript is Script {
    ...
    function setUpNewTokens() public {
        tokenA = new SafToken("SafDToken", "safD", 4, 2_000_0000);
        tokenB = new SafToken("SafWToken", "safW", 2, 1_000_00);
    ...
    function run() public {
        ...
        swapProxy.initialize("SwapPool-A2B", "lpA2B", 0, address(tokenA), address(tokenB), ud(0.003e18));
